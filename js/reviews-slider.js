...
const changeSection9rewievsHeaderRus = document.querySelector(".section-9__rewievs-header-rus");
const changeSection9rewievsHeaderEng = document.querySelector(".section-9__rewievs-header-eng");

const changeSection9rewievsHeaderTxtRus = document.querySelector(".section-9__rewievs-header-txt-rus");
const changeSection9rewievsHeaderTxtEng = document.querySelector(".section-9__rewievs-header-txt-eng");

const changesection9rewievsArticleRus = document.querySelector(".section-9__rewievs-article-rus");
const changesection9rewievsArticleEng = document.querySelector(".section-9__rewievs-article-eng");

const changeSection9rewievsHidden = document.querySelector(".section-9__rewievs-hidden");
